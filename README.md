...
UiPath RPA fundamentals -- daily practice workflows built as part of PEPC-10.
...
| Temperature above 30 degree.xaml | Check if temperature is above 30 degrees C (Hot/Cool) |
...
| read_range.xaml | Read a range of cells from Excel |
...
| File | Task |
|---|---|
| Main.xaml | Entry point workflow for the Day-9 project |
| EmailFilterAutomation.xaml | Filter/process emails matching specified criteria |
| RPASelectionMailAutomation.xaml | Send selection-status emails based on candidate data |
| RPA_SelectedCandidates.xlsx | Candidate data source (input spreadsheet) |
| Sample.pdf | Sample document used/generated by the automation |
| example.xaml | Reference/example workflow |
| project.json / entry-points.json / project.uiproj | UiPath project configuration files |
